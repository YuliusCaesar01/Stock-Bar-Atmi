        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                <div class="flex items-center ms-3">
                    <div class="flex">
                        <button type="button"
                            class="flex text-sm bg-gray-59 rounded-full focus:ring-4 focus:ring-gray-900 border"
                            aria-expanded="false" data-dropdown-toggle="dropdown-user">
                            <span class="sr-only">Open user menu</span>
                            <img class="w-8 h-8 rounded-full" src="{{ asset('user.png') }}" alt="user photo">
                        </button>
                        <span class="ms-3 mt-2 text-gray-900">{{ Auth::user()->name }}</span>
                    </div>
...
<aside id="separator-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-10 transition-transform -translate-x-full translate-x-0"
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 :bg-gray-800 mt-3">
        {{-- <a href="{{ route('dashboard') }}" class="flex items-center ps-2.5 mb-5">
            ...
            <span
                class="self-center text-xl font-semibold whitespace-nowrap text-gray-900 dark:text-dark">StockBar</span>
        </a> --}}
        <ul class="space-y-2 font-medium"><!--UpperSide-->
            <li>
                <a href="{{ route('dashboard') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-dark hover:bg-gray-100 dark:hover:bg-gray-200 group">
            ...
            @if (Auth::user()->role == 'superadmin' || Auth::user()->role == 'admin')
                <li><!--Setup-->
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-dark dark:hover:bg-gray-200"
                    ...
                    <ul id="dropdown-setup" class="hidden py-2 space-y-2">
                        <li>
                            ...
                            @if (Auth::user()->role == 'superadmin' || Auth::user()->name == 'Ika')
                                <a href="{{ route('setupproduksi') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-dark dark:hover:bg-gray-200">
                                    <svg class="w-6 h-6 text-gray-800" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="currentColor" viewBox="0 0 24 24">
        ...
        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700"><!--LowerSide-->
            {{-- <li>
                <a href="{{ route('profile.edit') }}"
                    class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-200 dark:text-dark group">
                    <svg class="w-6 h-6 text-gray-800 dark:text-dark" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
