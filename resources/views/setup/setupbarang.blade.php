                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form class="space-y-6" action="{{ route('nama-barang.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" name="satuan" id="satuan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-500 dark:placeholder-gray-400 dark:text-dark" required>
                        </div>
