<form action="{{ $action }}" method="POST">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        <div>
            ...
            <input type="text" id="no_barcode" name="no_barcode" value="{{ old('no_barcode', $barang->no_barcode ?? '') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="-" required readonly />
        </div>
        <div>
            <label for="no_item" class="block mb-2 text-sm font-medium text-gray-900 dark:text-dark">No Item</label>
            <input type="text" id="no_item" name="no_item" value="{{ old('no_item', $barang->no_item ?? '') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="-" required readonly />
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" id="kd_akun" name="kd_akun" value="{{ old('kd_akun', $barang->kd_akun ?? '') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="-" required readonly/>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="number" id="jumlah_maksimal" name="jumlah_maksimal" value="{{ old('jumlah_maksimal', $barang->jumlah_maksimal ?? '') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="-" required />
        </div>
        <div>
